...
namespace EducationalCenterDataAccess
{
    ...
    {
        public static bool GetStudentInfoByID(int StudentID, ref int PersonID, ref string Grad, ref int CreatedByUserID)
        {
            bool IsFound = false;
        ...
        public static int AddNewStudent(int PersonID, string Grad, int CreatedByUserID)
        {
            int StudentID = -1;
        ...
        public static bool UpdateStudent(int StudentID, int PersonID, string Grad, int CreatedByUserID)
        {
            int RowAffected = 0;
